...
UI DESIGN ┄ <small>Interface design, prototyping, user flows, responsive design, accessibility</small>  
...
- Translating between designer-speak and developer-speak
- Convincing teams that design systems shouldn't be optional (even CEOs)
- Running workshops where people learn things AND have opinions
